...
export default function EditBlogPage({ params }: { params: { id: string } }) {
    ...
    return (
      <div className="flex items-center justify-center h-full p-8">
        <div className="animate-pulse flex flex-col items-center space-y-4">
          ...
          <p className="text-[hsl(var(--foreground))] font-medium">Loading blog details...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--gold-hsl))] bg-clip-text text-transparent">Edit Blog</h1>
